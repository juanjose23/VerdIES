    ...
    <div class="col-xxl-8 mb-6 order-0">
        <div class="card">
            <div class="d-flex align-items-start row">
                <div class="col-sm-7">
                    <div class="card-body">
                        <h5 class="card-title text-primary mb-3">VISTA ADMINISTRADOR 🎉</h5>
                ...
                <div class="col-sm-5 text-center text-sm-left">
                    <div class="card-body pb-0 px-0 px-md-6">
                        <img src="{{ asset('Administrador/assets/img/illustrations/man-with-laptop.png') }}" height="175" class="scaleX-n1-rtl" alt="View Badge User">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between mb-4">
                            <div class="avatar flex-shrink-0">
                                <img src="{{ asset('Administrador/assets/img/icons/unicons/wallet-info.png') }}" alt="wallet info" class="rounded">
                            </div>
                            <div class="dropdown">
            ...
            <div class="col-6 mb-6">
                <div class="card h-100">
                    <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between mb-4">
                            <div class="avatar flex-shrink-0">
                                <img src="{{ asset('Administrador/assets/img/icons/unicons/paypal.png') }}" alt="paypal" class="rounded">
                            </div>
                            <div class="dropdown">
                ...
                <div class="tab-content p-0">
                    <div class="tab-pane fade show active" id="navs-tabs-line-card-income" role="tabpanel">
                        <div class="d-flex mb-6">
                            <div class="avatar flex-shrink-0 me-3">
                                <img src="{{ asset('Administrador/assets/img/icons/unicons/wallet-primary.png') }}" alt="User">
                            </div>
                            <div>
            ...
            <div class="card-body pt-4">
                <ul class="p-0 m-0">
                    <li class="d-flex align-items-center mb-6">
                        <div class="avatar flex-shrink-0 me-3">
                            <img src="{{ asset('Administrador/assets/img/icons/unicons/paypal.png') }}" alt="User" class="rounded">
                        </div>
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                    ...
                    <li class="d-flex align-items-center mb-6">
                        <div class="avatar flex-shrink-0 me-3">
                            <img src="{{ asset('Administrador/assets/img/icons/unicons/wallet.png') }}" alt="User" class="rounded">
                        </div>
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                    ...
                    <li class="d-flex align-items-center mb-6">
                        <div class="avatar flex-shrink-0 me-3">
                            <img src="{{ asset('Administrador/assets/img/icons/unicons/chart.png') }}" alt="User" class="rounded">
                        </div>
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                    ...
                    <li class="d-flex align-items-center mb-6">
                        <div class="avatar flex-shrink-0 me-3">
                            <img src="{{ asset('Administrador/assets/img/icons/unicons/cc-primary.png') }}" alt="User" class="rounded">
                        </div>
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                    ...
                    <li class="d-flex align-items-center">
                        <div class="avatar flex-shrink-0 me-3">
                            <img src="{{ asset('Administrador/assets/img/icons/unicons/cc-warning.png') }}" alt="User" class="rounded">
                        </div>
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <div class="timeline-event">
                            ...
                            <div class="d-flex align-items-center mb-1">
                                <div class="badge bg-lighter rounded-2">
                                    <img src="{{ asset('Administrador/assets/img/icons/misc/pdf.png') }}" alt="img" width="15" class="me-2">
                            ...
                            <div class="d-flex justify-content-between flex-wrap gap-2">
                                <div class="d-flex flex-wrap align-items-center">
                                    <div class="avatar avatar-sm me-2">
                                        <img src="{{ asset('Administrador/assets/img/avatars/1.png') }}" alt="Avatar" class="rounded-circle">
                                    </div>
                                    <div>
                                    ...
                                    <div class="d-flex flex-wrap align-items-center">
                                        <ul class="list-unstyled users-list d-flex align-items-center avatar-group m-0 me-2">
                                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Vinnie Mostowy" class="avatar pull-up">
                                                <img class="rounded-circle" src="{{ asset('Administrador/assets/img/avatars/5.png') }}" alt="Avatar">
                                            </li>
                                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Allen Rieske" class="avatar pull-up">
                                                <img class="rounded-circle" src="{{ asset('Administrador/assets/img/avatars/12.png') }}" alt="Avatar">
                                            </li>
                                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Julee Rossignol" class="avatar pull-up">
                                                <img class="rounded-circle" src="{{ asset('Administrador/assets/img/avatars/6.png') }}" alt="Avatar">
                                            </li>
                                            <li class="avatar">
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('Administrador/assets/img/icons/brands/chrome.png') }}" alt="Chrome" height="24" class="me-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('Administrador/assets/img/icons/brands/safari.png') }}" alt="Safari" height="24" class="me-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('Administrador/assets/img/icons/brands/firefox.png') }}" alt="Firefox" height="24" class="me-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('Administrador/assets/img/icons/brands/edge.png') }}" alt="Edge" height="24" class="me-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('Administrador/assets/img/icons/brands/opera.png') }}" alt="Opera" height="24" class="me-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('Administrador/assets/img/icons/brands/uc.png') }}" alt="uc" height="24" class="me-3">
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('Administrador/assets/img/icons/brands/windows.png') }}" alt="Windows" height="24" class="me-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('Administrador/assets/img/icons/brands/mac.png') }}" alt="Mac" height="24" class="me-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('Administrador/assets/img/icons/brands/ubuntu.png') }}" alt="Ubuntu" height="24" class="me-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('Administrador/assets/img/icons/brands/cent.png') }}" alt="Cent" height="24" class="me-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('Administrador/assets/img/icons/brands/linux.png') }}" alt="linux" height="24" class="me-3">
