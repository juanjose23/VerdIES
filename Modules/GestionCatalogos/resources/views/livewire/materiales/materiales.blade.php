                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="d-flex justify-content-end flex-wrap mt-3 mt-md-0">
                            ...
                            @can('create', Modules\GestionCatalogos\Models\Categorias::class)
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                @can('delete', Modules\GestionCatalogos\Models\Categorias::class)
                                        ...
                                        <form id="deleteForm{{ $material->id }}"
                                            action="{{ route('materiales.destroy', $material->id) }}" method="POST"
                                            style="display: none;">
                                            @csrf
                                            @method('DELETE')
