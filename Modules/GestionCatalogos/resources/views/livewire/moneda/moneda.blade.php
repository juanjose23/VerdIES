<div>
                        ...
                        @can('create', Modules\GestionCatalogos\Models\Categoria::class)
                            <div class="btn-group me-2 mb-2 mb-md-0">
                                <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas"
                                    ...
                                    <i class="fas fa-plus me-1"></i> Registrar Moneda
                                </button>
                            </div>
                        @endcan
                    ...
                    <tbody>
                        @foreach ($Monedas as $item)
                            <tr>
                                ...
                                <td>
                                    @if ($item->imagenes)
                                        <img src="{{ $item->imagenes->url }}" alt="Imagen de la moneda" width="50">
                                    @else
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            @can('update', Modules\GestionCatalogos\Models\Categoria::class)
                                            <!-- Botón para editar la categoría -->
                                            <a class="dropdown-item" href="{{ route('monedas.edit', ['monedas' => $item->id])}}">
                                                <i class="bx bx-edit-alt me-1"></i> Subir Logo
                                            </a>
                                        @endcan
    ...
    <div wire:ignore.self class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRightedit"
        ...
        <div class="offcanvas-header">
            <h5 id="offcanvasRightLabel">Editar Moneda {{ $nombre }}</h5>
    ...
    <div wire:ignore.self class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight"
        aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header">
            <h5 id="offcanvasRightLabel">Crear Nueva Moneda</h5>
            <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            @if (session()->has('message'))
