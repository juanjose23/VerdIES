...
use Modules\GestionCatalogos\Models\Tasas;
...
class MaterialService
{
    ...
    public function __construct(Materiales $MaterialModel, Media $MediaModel, Categoria $CategoriasModel, Tasas $TasasModel)
    {
     ...
     *
     * @param  \Modules\GestionCatalogos\Models\Categoria  $categoria
     * @return string
     */
    public function generarCodigoMaterial(Categoria $categoria)
    {
     ...
     *
     * @param  int  $id
     * @return \ Modules\GestionCatalogos\Models\Materiales
     * @throws \Exception
     */
