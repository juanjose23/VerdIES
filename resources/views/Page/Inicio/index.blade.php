...
@section('content')
                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-lg-6">
                            <figure class="hero__img d-none d-lg-block f-right" data-animation="fadeInRight"
                                data-delay="1s">
                                <img src="{{ asset('assets/img/hero/hero_right.png') }}" alt="Hero Image">
                            </figure>
                        </div>
                    </div>
                </div>
    ...
    <section class="best-features-area section-padd4">
        ...
        <div class="features-shpae d-none d-lg-block">
            <img src="{{ asset('assets/img/shape/best-features.png') }}" alt="">
        </div>
    </section>
                ...
                <div class="col-xl-8 col-lg-8 col-md-7">
                    <div class="app-active owl-carousel">
                        <figure class="single-cases-img">
                            <img src="{{ asset('assets/img/gallery/App1.png') }}" alt="Captura de Pantalla 1">
                        </figure>
                        <figure class="single-cases-img">
                            <img src="{{ asset('assets/img/gallery/App2.png') }}" alt="Captura de Pantalla 2">
                        </figure>
                        <figure class="single-cases-img">
                            <img src="{{ asset('assets/img/gallery/App3.png') }}" alt="Captura de Pantalla 3">
                        </figure>
                        <figure class="single-cases-img">
                            <img src="{{ asset('assets/img/gallery/App2.png') }}" alt="Captura de Pantalla 4">
                        </figure>
                        <figure class="single-cases-img">
                            <img src="{{ asset('assets/img/gallery/App1.png') }}" alt="Captura de Pantalla 5">
                        </figure>
                    </div>
                </div>
            </div>
