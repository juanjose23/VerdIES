<div>
    <div class="row">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4"><span class="text-muted fw-light">Gestión reciclaje /</span>Entregas a recicladoras</h4>
            <div class="card">
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table">
                        <caption class="ms-4">
                            Lista de entregas a recicladoras'
                        </caption>
                        <thead>
                            <tr>
                                <th>#</th>
                        ...
                        <tbody>
                            @foreach ($entregas as $entrega)
                                <tr class="odd">
                                    <td>{{ $loop->index + 1 }}</td>
                                    <td>{{ $entrega->recicladoras->nombre }}</td>
                                    <td>{{ $entrega->users->name }}</td>
                                    <td>{{ $entrega->codigo }}</td>
                                    <td>C$ {{ $entrega->total }}</td>

                                    <td>
                                        <span
                                            class=" badge bg-label-{{ $entrega->estado == 1 ? 'success' : 'success' }} me-1">
                                            {{ $entrega->estado == 1 ? 'Exitosa' : 'Exitosa' }}
                                        </span>
                                    </td>
