                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="nombre" name="nombre"
                                                ...
                                                <input type="text" name="user" value="{{$entrega->users_id}}" hidden>
                                            @error('nombre')
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            <label for="centro_acopio" class="form-label text-dark">Centro de acopio
                                                *</label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select id="estado" name="estado"
                                                ...
                                                <option value="1"
                                                    {{ old('estado', $entrega->estado) == '1' ? 'selected' : '' }}>Verificar
                                                </option>
                                                <option value="2"
                                                    {{ old('estado', $entrega->estado) == '0' ? 'selected' : '' }}>
                                                    Verificado</option>
                                            </select>
                                            @error('estado')
                                                <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-12">
                                <div class="card h-100">
                                    <div class="card-body">
                                        ...
                                        @if ($entrega->imagenes && $entrega->imagenes->url)
                                            <img class="img-fluid d-flex mx-auto my-4 rounded"
                                                src="{{ $entrega->imagenes->url }}" alt="Card image cap" />
                                            <a href="{{ $entrega->imagenes->url }}" target="_blank"
                                                class="card-link">Ver</a>
                                        @else
                                <p class="text-muted">No hay evidencia disponible.</p>
                                        @endif
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="d-flex justify-content-start align-items-center user-name">
                                                    <div class="avatar-wrapper">
                                                        @if ($material->materiales->imagenes)
                                                            <div class="avatar avatar-sm me-3">
                                                                <img src="{{ $material->materiales->imagenes->url }}"
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <a href="" class="text-body text-truncate">
                                                            <span
                                                                class="fw-medium">{{ $material->materiales->nombre }}</span>
                                                        </a>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-wrap cantidad" data-cantidad="{{ $material->cantidad }}">
                                                {{ wordwrap($material->cantidad, 50, "\n", true) }}</td>
                                            <td class="text-wrap">{{ wordwrap($material->valor, 50, "\n", true) }}
                                                {{ $material->monedas->nombre }}</td>
                                            <td>
                                                <button type="button" class="btn btn-warning btn-edit"
                                                    data-id="{{ $material->materiales_id }}"
                                                    data-cantidad="{{ $material->cantidad }}">Editar</button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
