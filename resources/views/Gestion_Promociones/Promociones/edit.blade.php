...
@section('content')
    <form action="{{  route('promociones.update', ['promociones' => $promocion->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div
            ...
            <div class="d-flex flex-column justify-content-center">
                <h4 class="mb-1">Editar promoción</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-6">
                            ...
                            @enderror"
                                    ...
                                    value="{{ old('fecha', $promocion->fecha_vencimiento ? $promocion->fecha_vencimiento->format('Y-m-d') : '') }}"
                                    >
                                @error('fecha')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div>
                            ...
                            <textarea name="descripcion" class="form-control" id="" cols="30" rows="10" >{{old('descripcion',$promocion->descripcion  )}}</textarea>
                            @error('descripcion')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="card mb-6">
                    ...
                    <div class="card-body">
                        <div class="row mb-6">
                            ...
                            <input type="file"
                                class="form-control @error('imagen')  is-invalid @enderror "id="imageInput" name="imagen"
            ...
            <div class="col-12 col-lg-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" class="form-control @error('precio') is-invalid @enderror"
                                ...
                                value="{{ old('precio',$promocion->detalles->valor) }}">
                            @error('precio')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" class="form-control  @error('preciomoneda') is-invalid @enderror"
                                ...
                                value="{{ old('preciomoneda',$promocion->detalles->cantidadmoneda) }}">
                            @error('preciomoneda')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                ...
                <div class="card mb-6">
                    ...
                    <div class="card-body">
                            ...
                            <select style="width: 100%" id="categorias" name="categorias"
                                ...
                                @foreach ($categorias as $categoria)
                                    <option value="{{ $categoria->id }}"
                                        {{ old('categorias', $promocion->categorias_id ?? '') == $categoria->id ? 'selected' : '' }}>
                                        {{ $categoria->nombre }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-6 col">
                            <label class="form-label mb-1" for="status-org">Estado</label>
                            <select id="estado" name="estado" class="select2 form-select @error('estado') is-invalid @enderror">
