        ...
        <div class="row justify-content-end">
            <div class="col-xl-8 col-lg-10">
                ...
                <div class="row">
                    ...
                    <article class="col-xl-6 col-lg-6 col-md-6">
                        <iframe style="border-radius:12px" src="https://open.spotify.com/embed/playlist/1ibTlqUyamBSpAmo6ZTNP1?utm_source=generator" width="100%" height="352" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
                    </article>
                    <article class="col-xl-6 col-lg-6 col-md-6">
                        <div class="feature-item mb-70">
                            <div class="feature-icon">
            ...
            <div class="col-xl-4 col-lg-4 col-md-8">
                ...
                <div id="video-section">
                    <iframe id="youtube-video" width="560" height="315"
                        src="https://www.youtube.com/embed/2EDCpDXMowc?enablejsapi=1&autoplay=0&mute=1"
...
<script>
    ...
    function onPlayerReady(event) {
      ...
      // Detectar cuando el video está visible
      window.addEventListener('scroll', function() {
        var rect = videoSection.getBoundingClientRect();
        if (rect.top >= 0 && rect.bottom <= window.innerHeight) {
          player.playVideo();
        } else {
          player.pauseVideo(); // Pausar si el video sale de la vista
        }
      });
    }
  </script>
