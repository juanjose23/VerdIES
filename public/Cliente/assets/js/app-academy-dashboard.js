let isDarkStyle = false; // o false, según el caso

!function () {
    let e, r, a;

    a = (isDarkStyle ?
        (e = config.colors_dark.textMuted, r = config.colors_dark.headingColor, config.colors_dark) :
        (e = config.colors.textMuted, r = config.colors.headingColor, config.colors)).borderColor;
    ...
    var s = document.querySelector("#leadsReportChart");
    ...
    let n = {
        ...
        labels: ["Botellas de plástico", "Cajas", "Tapas de botellas", "Vidrio", "Bolsas", "Composta"],
        series: [{
    ...
    t.length && (i = t.DataTable({
        ...
        columnDefs: [{
            ...
            render: function (e, a, t, s) {
                ...
                t = i ? '<img src="' + assetsPath + "img/avatars/" + i + '" alt="Avatar" class="rounded-circle">' :
                    '<span class="avatar-initial rounded-circle bg-label-' +
                    ["success", "danger", "warning", "info", "dark", "primary", "secondary"][Math.floor(6 * Math.random())] +
                    '">' + (i = (((i = t.user.match(/\b\w/g) || []).shift() || "") + (i.pop() || "")).toUpperCase()) + "</span>";

                return '<div class="d-flex align-items-center"><span class="me-4">' + l[r] + '</span><div><a class="text-heading text-truncate fw-medium mb-2 text-wrap" href="app-academy-course-details.html">' +
                    o + '</a><div class="d-flex align-items-center mt-1"><div class="avatar-wrapper me-2"><div class="avatar avatar-xs">' +
                    t + '</div></div><small class="text-nowrap text-heading">' + n + "</small></div></div></div>"
            }
        }, {
            targets: 3,
            ...
            render: function (e, a, t, s) {
                var r = t.status;
                return '<div class="d-flex align-items-center gap-3"><p class="fw-medium mb-0 text-heading">' + r +
                    '</p><div class="progress w-100" style="height: 8px;"><div class="progress-bar" style="width: ' + r + '" aria-valuenow="' + r + '" aria-valuemin="0" aria-valuemax="100"></div></div><small>' + t.number + "</small></div>"
            }
        }, {
            targets: 5,
            render: function (e, a, t, s) {
                return '<div class="d-flex align-items-center justify-content-between"><div class="w-px-50 d-flex align-items-center"><i class="bx bx-user bx-lg me-1_5 text-primary"></i><span>' +
                    t.user_number + '</span></div><div class="w-px-50 d-flex align-items-center"><i class="bx bx-book-open bx-lg me-1_5 text-info"></i><span>' +
                    t.note + '</span></div><div class="w-px-50 d-flex align-items-center"><i class="bx bx-video bx-lg me-1_5 text-danger"></i><span>' + t.view + "</span></div></div>"
            }
        }],
        order: [
            [2, "desc"]
