...
class MaterialService
{
    ...
    public function CrearMaterial(array $data)
    {
    ...
    public function obtenerMaterialesConCategoriasPorTasa($tasas)
    {
        // Usamos el modelo MaterialModel para obtener los materiales y sus categorías
        $materiales = $this->MaterialModel->with(['categorias'])->find($tasas);
